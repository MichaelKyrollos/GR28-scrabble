    ...
    public void createGameBoard(File customBoard) {
        if (customBoard == null) {
            try {
                ...
                this.messageScrabbleViews("Default board XML is either missing or " +
    ...
    public boolean playWord(PlayWordEvent playEvent) {
        ...
        if (isWord)
        {
            ...
            if (currentPlayer.playWord(playEvent)) {
                this.messageScrabbleViews("You have successfully played \"" +
            ...
            this.messageScrabbleViews("\""+ word.toUpperCase() +
